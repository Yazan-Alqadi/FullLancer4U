...
@endif --}}
    ...
    <div class="m-3">
        <span class="bg-info p-2 rounded text-dark">
            ...
            <a href="{{ route('checkout',$profession->id) }}" class="text-dark text-decoration-none"> Buy this service </a>
        </span>
    </div>
                    ...
                    <div class="card bg-light text-start text-dark rounded">
                        <div class="card-body">
                            <div class="card-text d-inline-block">
                                <div>
                                    <span>Rating:</s <link href="{{ asset('css/bootstrap.min.css') }}"
                                            rel="stylesheet">pan>
                            ...
                            <div class="card-text">
                                ...
                                <div class="d-inline-grid">
                                    <span class="card-title">
                                        <a href="{{ route('profile_user', Auth::user()->id) }}"
                    ...
                    <div class="card bg-light text-start text-dark rounded">
                        <div class="card-body text-center">
                            <a href="{{ route('contact_me', $profession->freelancer->user->id) }}" type="button"
                                class="btn btn-info @if (Auth::user()->is_freelancer && $profession->freelancer_id == Auth::user()->freelancer->id) disabled @endif">Contact</a>
                        </div>
                    </div>
                ...
                <div class="card bg-light text-start text-dark mb-4 rounded">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('buy_service', $profession->id) }}" type="submit"
                            class="btn btn-info mt-2 @if (Auth::user()->is_freelancer && $profession->freelancer_id == Auth::user()->freelancer->id) disabled @endif"
                            id="buy">Buy,
                        ...
                        <section class="py-5 section-style">
                            <div class="container">
                                <div class="row text-center">
                                    @foreach ($professions as $service)
