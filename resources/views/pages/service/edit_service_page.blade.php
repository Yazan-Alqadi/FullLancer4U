...
<section class="bg-light text-dark mg w-75 p-3 rounded mgg">
    ...
    <form action="{{ route('update_service',$service->id) }}">
        @csrf
        <div class="container mt-4">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" type="text" class="form-control" style="height: 200px !important;"
                          ...
                          aria-describedby="inputGroup-sizing-default" id="exampleFormControlInput1"
                          placeholder="Type at least 2 lines">{{ $service->description }}</textarea>
            </div>
