                ...
                <form action="">
                    ...
                    <div class="div-profile-image">
                        ...
                        <div class="input-group mb-3 d-inline-block">
                            <input type="text" name="full-name" class="form-control mx-auto" placeholder="Username"
                                aria-label="Username" aria-describedby="basic-addon1" style="width: 30%;">
                        </div>
                        ...
                        <div style="display: flex; align-items: baseline; justify-content: space-between;"
                            ...
                            <span class="text-start">
                                ...
                                <a href="#" class="ms-1 text-decoration-none fst-italic text-secondary"> My
                                    facebook
                                </a>
                            </span>
                            <span>
                                <button class="p-1 border border-0 bg-light font-ar text-danger"
                        ...
                        {{-- Add links --}}
                        <button class="btn btn-outline-secondary mb-3" data-bs-target="#collapseExample"
                    ...
                    <button class="btn p-1 my-3" type="submit"
                        style="background-color: #5e1155;border-color: #5e1155; color: antiquewhite;">submit</button>
