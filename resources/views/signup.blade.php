        ...
        <div class="form-login-div">
            <form class="form-login-1">
                ...
                <div class="wrap-input" data-validate="Password is required">
                    ...
                    <input class="input1" type="text" name="password" minlength="8" required
                        placeholder="*************">
                </div>
                <div class="wrap-input" data-validate="Repeat Password is required">
                    <span class="label-input">Repeat Password</span>
                    <input class="input1" type="text" name="repeat-pass" minlength="8" required
                        placeholder="*************">
                </div>
                <div class="container-login-form-btn">
                    <div class="login-btn-confirm" style="display: inline;">
