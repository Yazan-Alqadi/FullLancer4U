        ...
        <form method="POST" action="{{ route('update_project',$project->id) }}">
            ...
            <div class="container mt-4">
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="title" type="text" class="form-control" value="{{ $project->title }}" aria-label="Sizing example input"
                        placeholder="Type Title" aria-describedby="inputGroup-sizing-default">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Price</span>
                    <input name="price" type="text" value="{{ $project->price }}" class="form-control" aria-label="Sizing example input"
