        ...
        <div class="collapse navbar-collapse" id="mainmenu">
            ...
            @else
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a href="{{ route('register.show') }}" class="nav-link">{{ __('home.register') }}</a></li>
                    <li class="nav-item"><a href="{{ route('login') }}" class="nav-link">{{ __('home.signUp') }}</a></li>
                </ul>
            @endauth
