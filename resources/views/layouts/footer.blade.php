    ...
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-4 mt-4 border-top">
            <div class="col-md-6 d-flex align-items-center">
                ...
                <span class="mb-3 mb-md-0 text-muted">2022 Company, Inc. All rights reserved.</span>
            </div>
...
<section class="bg-dark text-light h6 mt-5">
    ...
    <div class="row px-5 pb-3 border-bottom border-light me-0">
        ...
        <div class="col-lg-4 col-md-4 px-5">
            <div class="mb-2 fw-bold">Follow us for any updates</div>
            <div>
            ...
            <div class="mb-2 mt-4 fw-bold">Call us</div>
            <div>+963 98-7424-089</div>
        </div>
    </div>
    <div class="row px-5 border-light me-0">
        <div class="col-lg-8 col-md-8 px-5 my-3 d-flex">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-c-circle-fill" viewBox="0 0 16 16">
                    <path
            ...
            <div class="mb-3 ms-1">2023 All rights reserved.</div>
        </div>
