                ...
                <div class="profile-icon-post mb-3" style="text-align: center; ">
                    ...
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                            style="color: #5e1155; left: 0%; position: relative; top: -40px;" fill="currentColor"
            ...
            <div class="menu-post">
                ...
                <div class="btn-group dropstart">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <button class="dropdown-item" type="button" style="font-size: 12px;">Sexual violent
                            </button>
                        </li>

                        <li>
                            <button class="dropdown-item" type="button" style="font-size: 12px;">wrong information
                            </button>
                        </li>
