<div>
    @forelse ($accounts as $acc)
        @if ($acc['account'] == 'facebook')
            <div style="display: flex; align-items: baseline; justify-content: space-between;" class="my-2">
                ...
                <span class="text-start">
                    ...
                    <a href="{{ $acc['link'] }}" class="ms-1 text-decoration-none fst-italic text-secondary"
                        target='_blank'>
                        {{ $acc['user_name'] }}
                    </a>
                </span>
        ...
        @elseif ($acc['account'] == 'linkedIn')
            {{-- LinkedIn account --}}
            <div class="text-start my-2" style="display: flex; align-items: baseline; justify-content: space-between;">
                <span>
