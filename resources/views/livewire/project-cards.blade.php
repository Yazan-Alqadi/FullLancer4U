        ...
        <div class="row justify-content-between m-0">
            ...
            <div class="col-lg-4 col-md-5" >
                <div class="input-group w-100" >
                    <input wire:model.defer="searchText" label="Title" name="title" type="text" class="form-control" id="inputTitle"
                        placeholder="Search by title or price or client name ">
