<div class="border mt-2 d-flex p-0" style="align-items: baseline; justify-content: space-evenly;">
    ...
    <span class="">
        <button class="btn border-end border-start border-2 rounded-0"
            style="--bs-border-opacity: .5; border-color : #f0f8ff00" wire:click="dislike('{{ $reactions['post_id'] }}')">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="color: #5e1155;"
        ...
        <div class="offcanvas-body small">
            ...
            <div class="border rounded-5 my-3 px-3 pt-2">
                ...
                <div class="m-3 text-break">
                    comment is here, Lorem ipsum dolor sit amet consectetur
                    adipisicing
                    elit.
                    Beatae, excepturi repellat deleniti consectetur assumenda
                    blanditiis
                    a
                    sunt
                    in ex natus consequatur, pariatur reiciendis quos voluptatem
                    quam
                    amet
