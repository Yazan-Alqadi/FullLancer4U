...
class ServicePolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function edit(User $user,Profession $service)
    {
        return $user->id===$service->freelancer->user->id ? Response::allow()
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, Profession $service)
    {
        return $user->id===$service->freelancer->user->id? Response::allow()
        : Response::deny('You do not own this service.');
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Profession $service)
    {
        return $user->id ===$service->freelancer->user->id? Response::allow()
        : Response::deny('You do not own this service.');
    }
